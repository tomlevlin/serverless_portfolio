...
import ExampleWorkModel from './example-work-model'
  ...
  render () {
    return (
      <span>
        ...
        <ExampleWorkModel example={this.state.selectedExample} open={this.state.modalOpen} closeModal={this.closeModal}/>
      </span>
    )
  }
}
